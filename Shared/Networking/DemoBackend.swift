    ...
    init() {
        ...
        guests = [
            ...
            DemoGuest(vmid: 106, name: "k3s-worker-2", kind: "qemu", node: "pve-edge", cores: 2,
                      ...
                      snapshots: []),
            DemoGuest(vmid: 110, name: "web-frontend", kind: "lxc", node: "pve-alpha", cores: 2,
            ...
            DemoGuest(vmid: 113, name: "jellyfin", kind: "lxc", node: "pve-beta", cores: 6,
                      ...
                      snapshots: []),
            DemoGuest(vmid: 114, name: "homeassistant", kind: "lxc", node: "pve-edge", cores: 1,
                      maxmem: 512 * 1_048_576, maxdisk: 4 * gb, running: true, template: false,
                      tags: ["home"], seed: 3.4,
                      startedAt: Date().addingTimeInterval(-1_700_000), osType: "debian", pool: "home",
                      snapshots: []),
